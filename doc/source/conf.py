...
# -*- coding: utf-8 -*-
#
# cromosim documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'cromosim.tex', 'cromosim Documentation',
     'Sylvain Faure, Bertrand Maury', 'manual'),
]
...
man_pages = [
    (master_doc, 'cromosim', 'cromosim Documentation',
     [author], 1)
]
